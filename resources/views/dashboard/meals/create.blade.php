                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="col-lg-12 p-t-10">
                            <div class="card-box">
                                <h3 class="card-title text-center">Create New Meal</h3>
                                <br>
                        ...
                        <form method="POST" action="{{ route('meals.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="calories" type="number" class="form-control @error('calories') is-invalid @enderror" name="calories" value="{{ old('calories') }}" required autocomplete="calories" autofocus>
